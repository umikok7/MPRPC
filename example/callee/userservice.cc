...
/*
假设UserService是一个本地服务，提供两个进程内的本地方法，Login和GetFriendLists
*/
...
public:
    ...
    1. caller（服务消费者） ===> Login(LoginRequest) => muduo => callee
    2. callee（服务提供者） ===> Login(LoginRequest) => 交到下面重写的这个Login方法上了
    */
