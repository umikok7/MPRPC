...
class RequestCode :
 ...
 public:
  ...
  inline RequestCode* New() const final {
    return CreateMaybeMessage<RequestCode>(nullptr);
  }

  RequestCode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class LoginResponse :
 ...
 public:
  ...
  ::fixbug::RequestCode* release_result();
...
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestCode::_internal_errcode() const {
  return errcode_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestCode::errcode() const {
  // @@protoc_insertion_point(field_get:fixbug.RequestCode.errcode)
  return _internal_errcode();
}
inline void RequestCode::_internal_set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  errcode_ = value;
}
inline void RequestCode::set_errcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void RequestCode::set_errmsg(const std::string& value) {
...
inline void RequestCode::set_errmsg(std::string&& value) {
  
  errmsg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RequestCode.errmsg)
}
inline void RequestCode::set_errmsg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.RequestCode.errmsg)
}
inline void RequestCode::set_errmsg(const void* value, size_t size) {
  
  errmsg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RequestCode.errmsg)
}
...
inline const ::fixbug::RequestCode& LoginResponse::_internal_result() const {
  const ::fixbug::RequestCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::RequestCode*>(
      &::fixbug::_RequestCode_default_instance_);
}
inline const ::fixbug::RequestCode& LoginResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.result)
  return _internal_result();
}
inline ::fixbug::RequestCode* LoginResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.result)
  
  ::fixbug::RequestCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::RequestCode* LoginResponse::_internal_mutable_result() {
  
  if (result_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::RequestCode>(GetArenaNoVirtual());
    result_ = p;
  }
  return result_;
}
inline ::fixbug::RequestCode* LoginResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.result)
  return _internal_mutable_result();
}
inline void LoginResponse::set_allocated_result(::fixbug::RequestCode* result) {
