...
extern PROTOBUF_INTERNAL_EXPORT_test_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RequestCode_test_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_test_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_test_2eproto;
namespace fixbug {
class RequestCodeDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<RequestCode> _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListResponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListResponse_test_2eproto}, {
      &scc_info_RequestCode_test_2eproto.base,
...
static void InitDefaultsscc_info_RequestCode_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_RequestCode_default_instance_;
    new (ptr) ::fixbug::RequestCode();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::RequestCode::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RequestCode_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RequestCode_test_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::RequestCode, errcode_),
  PROTOBUF_FIELD_OFFSET(::fixbug::RequestCode, errmsg_),
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_RequestCode_default_instance_),
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\030\003 \003(\0132\036.fixbug.LoginRequest.TestEntry\032+"
  "\n\tTestEntry\022\013\n\003key\030\001 \001(\005\022\r\n\005value\030\002 \001(\t:"
  "\0028\001\"E\n\rLoginResponse\022#\n\006result\030\001 \001(\0132\023.f"
  "ixbug.RequestCode\022\017\n\007success\030\002 \001(\010\"&\n\024Ge"
  "tFriendListRequest\022\016\n\006userid\030\001 \001(\r\"[\n\004Us"
  "er\022\014\n\004name\030\001 \001(\014\022\013\n\003age\030\002 \001(\r\022\035\n\003sex\030\003 \001"
  "(\0162\020.fixbug.User.Sex\"\031\n\003Sex\022\007\n\003MAN\020\000\022\t\n\005"
  "WOMAN\020\001\"_\n\025GetFriendListResponse\022#\n\006resu"
  "lt\030\001 \001(\0132\023.fixbug.RequestCode\022!\n\013friend_"
  "list\030\002 \003(\0132\014.fixbug.User2\225\001\n\016UserService"
  "Rpc\0224\n\005Login\022\024.fixbug.LoginRequest\032\025.fix"
  "bug.LoginResponse\022M\n\016GetFriendLists\022\034.fi"
  "xbug.GetFriendListRequest\032\035.fixbug.GetFr"
  "iendListResponseB\003\200\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  &descriptor_table_test_2eproto_initialized, descriptor_table_protodef_test_2eproto, "test.proto", 669,
...
void RequestCode::InitAsDefaultInstance() {
}
...
RequestCode::RequestCode()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.RequestCode)
}
...
void RequestCode::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RequestCode_test_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  errcode_ = 0;
}
...
const RequestCode& RequestCode::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_RequestCode_test_2eproto.base);
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestCode::_InternalSerialize(
...
void RequestCode::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.RequestCode)
  GOOGLE_DCHECK_NE(&from, this);
  const RequestCode* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RequestCode>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.RequestCode)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.RequestCode)
    MergeFrom(*source);
  }
}
...
void RequestCode::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.RequestCode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void LoginResponse::InitAsDefaultInstance() {
  ::fixbug::_LoginResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::RequestCode*>(
      ::fixbug::RequestCode::internal_default_instance());
}
class LoginResponse::_Internal {
 public:
  static const ::fixbug::RequestCode& result(const LoginResponse* msg);
};
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_result()) {
    result_ = new ::fixbug::RequestCode(*from.result_);
  } else {
    result_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginResponse)
  ...
  if (from.has_result()) {
    _internal_mutable_result()->::fixbug::RequestCode::MergeFrom(from._internal_result());
  }
  if (from.success() != 0) {
...
void GetFriendListResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::RequestCode*>(
      ::fixbug::RequestCode::internal_default_instance());
}
...
template<> PROTOBUF_NOINLINE ::fixbug::RequestCode* Arena::CreateMaybeMessage< ::fixbug::RequestCode >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::RequestCode >(arena);
}
